...
<div class="card shadow mb-4">
   ...
   <form action="{{ route('supplier.update',$supplier->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <input type="hidden" name="oldphoto" value="{{ $supplier->logo }}">
    <div class="card-body">
            ...
            <div class="col-sm-10">
                ...
                <div class="tab-content mt-3" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-oldphoto" role="tabpanel" aria-labelledby="nav-oldphoto-tab">
                        <img src="{{ asset($supplier->logo) }}" class="img-fluid">
                    </div>
        ...
        <div class="form-row">
         ...
         <div class="form-row">
            <div class="form-group col-md-12 ">
                ...
                <input type="text" class="form-control" id="phoneno" name="phoneno" value="{{ $supplier->phoneno }}">
            </div>
        </div>
         <div class="form-row">
            <div class="form-group col-md-12 ">
